...
#define  COMBO_PATTERN_1A    ATTACK_RIGHT + ATTACK_K1, ATTACK_RIGHT, ATTACK_DOWN + ATTACK_RIGHT, ATTACK_DOWN
#define  COMBO_PATTERN_1B    ATTACK_RIGHT + ATTACK_K2, ATTACK_RIGHT, ATTACK_DOWN + ATTACK_RIGHT, ATTACK_DOWN
#define  COMBO_PATTERN_1C    ATTACK_RIGHT + ATTACK_K3, ATTACK_RIGHT, ATTACK_DOWN + ATTACK_RIGHT, ATTACK_DOWN
#define  COMBO_PATTERN_1D    ATTACK_LEFT + ATTACK_K1, ATTACK_LEFT, ATTACK_DOWN + ATTACK_LEFT, ATTACK_DOWN
#define  COMBO_PATTERN_1E    ATTACK_LEFT + ATTACK_K2, ATTACK_LEFT, ATTACK_DOWN + ATTACK_LEFT, ATTACK_DOWN
#define  COMBO_PATTERN_1F    ATTACK_LEFT + ATTACK_K3, ATTACK_LEFT, ATTACK_DOWN + ATTACK_LEFT, ATTACK_DOWN
...
//RASENHA
#define  COMBO_PATTERN_3A    ATTACK_LEFT + ATTACK_P1, ATTACK_LEFT, ATTACK_DOWN + ATTACK_LEFT, ATTACK_DOWN
#define  COMBO_PATTERN_3B    ATTACK_LEFT + ATTACK_P2, ATTACK_LEFT, ATTACK_DOWN + ATTACK_LEFT, ATTACK_DOWN
#define  COMBO_PATTERN_3C    ATTACK_LEFT + ATTACK_P3, ATTACK_LEFT, ATTACK_DOWN + ATTACK_LEFT, ATTACK_DOWN
#define  COMBO_PATTERN_3D    ATTACK_RIGHT + ATTACK_P1, ATTACK_RIGHT, ATTACK_DOWN + ATTACK_RIGHT, ATTACK_DOWN
#define  COMBO_PATTERN_3E    ATTACK_RIGHT + ATTACK_P2, ATTACK_RIGHT, ATTACK_DOWN + ATTACK_RIGHT, ATTACK_DOWN
#define  COMBO_PATTERN_3F    ATTACK_RIGHT + ATTACK_P3, ATTACK_RIGHT, ATTACK_DOWN + ATTACK_RIGHT, ATTACK_DOWN




//MEIOKEN
#define  COMBO_PATTERN_5A    ATTACK_P2 + ATTACK_K2

//EXDP
#define  COMBO_PATTERN_4A    ATTACK_LEFT + ATTACK_P1 + ATTACK_P2, ATTACK_LEFT, ATTACK_DOWN + ATTACK_LEFT, ATTACK_DOWN
#define  COMBO_PATTERN_4B    ATTACK_LEFT + ATTACK_P2 + ATTACK_P3, ATTACK_LEFT, ATTACK_DOWN + ATTACK_LEFT, ATTACK_DOWN
#define  COMBO_PATTERN_4C    ATTACK_LEFT + ATTACK_P4, ATTACK_LEFT, ATTACK_DOWN + ATTACK_LEFT, ATTACK_DOWN



//V-SKILL
#define  COMBO_PATTERN_6A    ATTACK_P3 + ATTACK_K3

//#define  COMBO_PATTERN_7     ATTACK_P3 + ATTACK_K3
